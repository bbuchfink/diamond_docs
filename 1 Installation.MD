...
downloaded for immediate use:
    ...
    wget http://github.com/bbuchfink/diamond/releases/download/v0.9.35/diamond-linux64.tar.gz
...
To pull a specific version:
    ...
    docker pull buchfink/diamond:version0.9.35
...
from source, invoke the following commands on the shell:
    ...
    wget http://github.com/bbuchfink/diamond/archive/v0.9.35.tar.gz
    tar xzf v0.9.35.tar.gz
    cd diamond-0.9.35
    mkdir bin
    cd bin
    cmake ..
