...
## Advanced options
  ...
  - `--no-ranking`
    ...
    Disable ranking heuristic. Ranking refers to establishing a tentative order
  ...
  - `--ext-chunk-size #`
    ...
    is the number specified by the `-k` option, rounded up to the next multiple
    of 32. When using `--top`, the default value is 32.
